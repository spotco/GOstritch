...
+(NSMutableArray*) loadBg {
    ...
    //[a addObject:[BackgroundObject backgroundFromTex:[Resource get_tex:TEX_BG_LAYER_2] scrollspd_x:0.05 scrollspd_y:0.15]];
    [a addObject:[BackgroundObject backgroundFromTex:[Resource get_tex:TEX_BG_LAYER_1] scrollspd_x:0.15 scrollspd_y:0.15]];
...
-(void)update:(ccTime)dt {
	for (BackgroundObject* s in bg_elements) {
        ...
        s.position = ccp(0,MAX(0,-[GameEngineLayer get_cur_pos_y]*s.scrollspd_y));
	}
}
